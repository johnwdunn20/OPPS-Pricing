...
import gov.cms.fiss.pricers.opps.core.rules.initialize_and_validate_claim.WageIndexTransitionAdjustment2021;
...
/** 2021 implementation of the OPPS pricer. */
public class Opps2021RulePricer extends OppsRulePricer {

  public Opps2021RulePricer(DataTables dataTables) {
            ...
            List.of(
                ...
                new DetermineWageIndex(
                    List.of(
                        ...
                        new WageIndexTransitionAdjustment2021())),
                new WageIndexCheck())),
  ...
  protected OppsPricerContext contextFor(OppsClaimPricingRequest input) {
    ...
    return new Opps2021PricerContext(input, output, dataTables);
  }
}
