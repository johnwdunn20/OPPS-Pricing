...
import gov.cms.fiss.pricers.opps.core.rules.initialize_and_validate_claim.WageIndexTransitionAdjustment;
...
/** 2020 implementation of the OPPS pricer. */
public class Opps2020RulePricer extends OppsRulePricer {

  public Opps2020RulePricer(DataTables dataTables) {
            ...
            List.of(
                ...
                new DetermineWageIndex(
                    List.of(
                        ...
                        new WageIndexTransitionAdjustment())),
                new WageIndexCheck())),
  ...
  protected OppsPricerContext contextFor(OppsClaimPricingRequest input) {
    ...
    return new Opps2020PricerContext(input, output, dataTables);
  }
}
