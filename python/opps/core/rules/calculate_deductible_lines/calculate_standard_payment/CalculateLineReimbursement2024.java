...
public class CalculateLineReimbursement2024 extends AbstractDeductibleLineRule {
  ...
  public void calculate(DeductibleLineContext calculationContext) {
    ...
    if (calculationContext.getPricerContext().isRehExcludeCoinsurance()
      ...
      // 2024 logic update for REH-PassThroughDevice, si = 'H' & provider type = '24'
    ...
    // New for 2023, exclude  REH- Provider Type '24' & '25'
